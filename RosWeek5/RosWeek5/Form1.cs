...
namespace RosWeek5
{
    public partial class Form1 : Form
    {
        ...
        public void filterrr()
        {
            ...
            foreach (string s in listproduk)
            {
                cbox_filter.Items.Add(s);
            }
        }
        public void cboxcategory()
        {
        ...
        public static List<string> listproduk = new List<string>() { "Jas", "T-Shirt", "Rok", "Celana", "Cawat" };
        public int simpan = 0;
        ...
        private void btn_addproduct_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        if (num <= Convert.ToInt32(dt.Rows[i][0].ToString().Substring(1)))
                        {
                            num = Convert.ToInt32(dt.Rows[i][0].ToString().Substring(1));
                        }
                    }
                }
        ...
        private void btn_editproduct_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (cbox_category.SelectedItem == listproduk[i])
                        {
        ...
        private void dtProdukSimpan_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            for (int i = 0; i < listproduk.Count; i++)
            {
